...
const authLimiter = createRateLimiter(15 * 60 * 1000, 20, 'Too many authentication attempts. Try again in 15 minutes.');
const apiLimiter = createRateLimiter(15 * 60 * 1000, 200);
const agentLimiter = createRateLimiter(60 * 1000, 60, 'Agent push rate exceeded.');
